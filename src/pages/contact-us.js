...
const TextInput = (props) => (
  <input {...props} className="p-2 border border-gray-400 block w-full" />
);
const Textarea = (props) => (
  <textarea
    {...props}
    rows={5}
    className="p-2 border border-gray-400 block w-full"
  />
);
...
const ContactUsPage = ({ data }) => {
  ...
  return (
    <div className="page container">
      ...
      <h1 className="page-heading">{formName}</h1>
      ...
      {!success && (
        <FormiumForm
          ...
          components={{
            ...
            Header: () => null,
            SubmitButton: (props) => (
              <button {...props} className="p-2 bg-purple-700 text-white w-24">
                Send
              </button>
            ),
          }}
